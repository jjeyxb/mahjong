...
給接手這個專案的下一個對話 / 下一個人。**最後更新 2026-09-09(安裝 / 清除清單、decisions 第十八節)。**
...
| 17 | ~~`decisions.md` 第十八節沒寫~~ | ✅ 2026-09-09 補上 | 兩次被真實牌譜推翻的經過、等級 vs 指名的界線、三種門檻的數據 |
| 18 | **放銃分析沒有對照評測** | 只有一場牌譜,講不出「N 場中從未把放銃牌判成安全」 | 缺的資料與 M8 缺的是同一批 —— 拿到牌譜可以一起解決 |
