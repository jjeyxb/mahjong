...
* :mod:`majsoul_copilot.groundtruth.capture_addon` —— mitmproxy(MITM 攔截)
* :mod:`majsoul_copilot.groundtruth.cdp` —— Chrome DevTools Protocol(讀瀏覽器已解密的 frame)
...
from majsoul_copilot.groundtruth.liqi import LiqiMessage, LiqiParseError, LiqiParser
