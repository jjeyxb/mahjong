...
from majsoul_copilot.engine.base import Advice, EngineError, EngineTimeout
from majsoul_copilot.mjai import NONE_ACTION, MjaiEvent, MjaiFormatError, parse_event
...
class SubprocessSpec:
    ...
    Attributes:
        name: 引擎名稱,會出現在 :attr:`~majsoul_copilot.engine.base.Advice.engine`。
...
class SubprocessEngine:
    """在子程序裡跑的 :class:`~majsoul_copilot.engine.base.AIEngine`。
